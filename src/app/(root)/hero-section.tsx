...
interface Props {}
const words = ["better", "cute", "beautiful", "modern"].map((word) => word.toUpperCase());
    ...
    <>
      <section className="container flex min-h-[50vh] flex-col gap-10 lg:flex-row">
        <div className="flex flex-1 flex-col items-center justify-center gap-4">
          ...
          <p className="text-lg">
            Concepts Source Inc is a leading design and manufacturing company, specializing in garments, scarves,
            jewelry, and home fashion products. With a focus on unique designs, high-quality services, and timely
            deliveries, we cater to the fashion needs of both men and women, offering collections for various
      ...
      <section className="container flex min-h-[50vh] flex-col gap-10 lg:flex-row">
        <div className="relative min-h-80 flex-1 overflow-hidden rounded-xl">
          <Image src={`https://picsum.photos/200/300?abc=fff`} alt="Creativity image" fill />
        </div>
        <div className="flex flex-1 flex-col items-center justify-center gap-4">
          <h1 className="text-5xl font-bold">
            Unleash Your Creativity with Our Custom Design and Manufacturing Capabilities
          </h1>
          <p className="text-lg">
            At Concepts Source Inc, we specialize in creating unique and customized designs for garments, scarves,
            jewelries, and home fashion products. With our high-quality services and timely deliveries, we ensure that
...
export const HeroSectionProductHighlight = () => {
  ...
  return (
    <div className="flex flex-1 overflow-y-hidden">
      ...
      <MovingCards speed="slow" className="h-[50vh] px-2 pt-60" items={secondPart} />
    </div>
  );
};
